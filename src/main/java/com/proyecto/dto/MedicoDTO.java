...
public class MedicoDTO implements Serializable {
	...
	public MedicoDTO(String nLicencia, String nombre, String especialidad, int consulta, String password,
			HospitalDTO hospital, List<CitaDTO> listaCitas, List<InformeDTO> listaInformes) {
	...
	public String toString() {
		return "MedicoDTO{" + "nLicencia=" + nLicencia + ", nombre=" + nombre + ", especialidad=" + especialidad
				+ ", consulta=" + consulta + ", hospital=" + hospital + ", listaCitas=" + listaCitas
